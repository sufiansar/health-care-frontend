import AppointmentConfirmation from "@/components/modules/Patients/PatientAppionment/AppointmentConfirmation";
import { getDoctorById } from "@/services/admin/doctorsManagement";
import { getScheduleById } from "@/services/admin/scheduleMenagement";
