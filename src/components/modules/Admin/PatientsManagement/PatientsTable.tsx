...
import { deletePatientById } from "@/services/admin/patientManagement";
import { IDoctor } from "@/types/doctors.interface";
import { IPatient } from "@/types/patient.interface";
import { useRouter } from "next/navigation";
import { useState, useTransition } from "react";
import { toast } from "sonner";
import { patientsColumns } from "./PatientsColum";
import ManagementTable from "../../shared/ManagementTable";
import DeleteConfirmationDialog from "../../shared/DeleteConfirmationDialog";
import PatientFormDialog from "./PatientFormDialog";
import PatientViewDetailDialog from "./PatientsViewDetailes";
...
const PatientsTable = ({ patients }: PatientsTableProps) => {
  ...
  const confirmDelete = async () => {
    ...
    setIsDeleting(true);
    const result = await deletePatientById(deletingPatient.id!);
    setIsDeleting(false);
