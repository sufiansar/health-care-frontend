...
const Testimonials = () => {
  return (
    <section className="bg-card dark:bg-gray-900 py-24 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          {testimonials.map((testimonial) => (
            <Card
              ...
              className="bg-background dark:bg-gray-800 relative text-foreground dark:text-gray-100 transition-colors duration-300"
            >
              <CardContent className="p-8">
                <Quote
                  className="absolute top-4 left-4 text-primary dark:text-blue-400"
                  size={48}
                />
                <div className="relative z-10">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <div className="ml-4">
                      <h4 className="font-bold text-foreground dark:text-gray-100">
                        {testimonial.name}
                      </h4>
