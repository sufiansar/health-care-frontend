...
const DoctorCard = ({ doctor }: { doctor: (typeof doctors)[0] }) => {
  return (
    <Card className="text-center overflow-hidden hover:shadow-xl transition-shadow duration-300 dark:bg-gray-800 dark:text-gray-100">
      <CardHeader className="bg-blue-50/50 dark:bg-gray-700 items-center p-6">
        <Image
          src={doctor.image}
          alt={doctor.name}
          width={96}
...
const TopRatedDoctors = () => {
  return (
    <section className="bg-blue-50/50 dark:bg-gray-900 py-24 transition-colors duration-300">
